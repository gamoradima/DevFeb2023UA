define("UsrRealty1Page", [], function() {
	return {
                    ...
                    "filters": [
                        function() {
							...
							subFilters.addItem(this.Terrasoft.createColumnFilterWithParameter(
								this.Terrasoft.ComparisonType.EQUAL, "UsrParentRealtyClassic", this.get("Id")));
		...
		details: /**SCHEMA_DETAILS*/{
			...
			"UsrSchemaa9a0caaaDetail027dbfbd": {
		...
		businessRules: /**SCHEMA_BUSINESS_RULES*/{
			"UsrComment": {
				"4f394df3-7299-4506-9dfe-d4ed620f7e42": {
					"uId": "4f394df3-7299-4506-9dfe-d4ed620f7e42",
					"enabled": true,
					"removed": false,
					"ruleType": 0,
					"property": 0,
		...
		methods: {
			...
			onMyButtonClick: function() {
				this.console.log("Кнопка ПИЩЬ працює...");
				this.showInformationDialog("Натиснули кнопку ПИЩЬ");
			...
			getMyButtonEnabled: function() {
				...
				this.console.log("getMyButtonEnabled method called");
				return result;
			}
		},
		...
		diff: /**SCHEMA_DIFF*/[
			{
				"operation": "insert",
				"name": "UsrName8af588a6-cedb-4617-8264-37daee7c6d73",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "FLOAT522c8b39-2d6d-4a58-b6fe-983856b99113",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "FLOATc5dca946-c826-49fb-af1e-6a820c3c3aa8",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "FLOATc4204525-52a4-4ae7-92f5-4a651caacb9a",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "LOOKUP4fb1de94-6342-4794-a1a5-21ef245c6975",
				"values": {
					"layout": {
						"colSpan": 12,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "LOOKUPc5e38dbe-7a65-4f35-b762-1e5604caf71f",
				"values": {
					"layout": {
						"colSpan": 12,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "STRINGf37f9f94-8674-4972-9333-c4bafde5f397",
				"values": {
					"layout": {
						"colSpan": 12,
						"rowSpan": 2,
			...
			{
				"operation": "insert",
				"name": "LOOKUP41fc5d0f-1c38-4c59-8ebe-47be81b9a2bb",
				"values": {
					"layout": {
						"colSpan": 12,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "Tab1bc441b6TabLabel",
				"values": {
					"caption": {
						"bindTo": "Resources.Strings.Tab1bc441b6TabLabelTabCaption"
					},
					"items": [],
					"order": 0
				},
			...
			{
				"operation": "insert",
				"name": "UsrSchemaa9a0caaaDetail027dbfbd",
				"values": {
					"itemType": 2,
					"markerValue": "added-detail"
				},
				"parentName": "Tab1bc441b6TabLabel",
				"propertyName": "items",
				"index": 0
			},
			{
